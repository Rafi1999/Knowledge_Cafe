...
const Sidebar = ({bookmarks,readTime}) => {
    ...
    return (
        ...
        <div className='text-center'>
            <h3 className='mt-3 text-2xl text-blue-600 border-blue-500 border py-3 rounded-lg font-bold'>Spent time on read : {time}min</h3>
        </div>
        <div className='mt-2 border rounded-lg px-3 py-2'>
            <h4 className='font-bold text-2xl'>Bookmarked Blogs: {books?.length}</h4>
            {
